...
public class GetCoordinatesByStreetcodeIdHandler : IRequestHandler<GetCoordinatesByStreetcodeIdQuery, Result<IEnumerable<PaymentResponseDTO>>>
{
    ...
    public async Task<Result<IEnumerable<PaymentResponseDTO>>> Handle(GetCoordinatesByStreetcodeIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Ok(_mapper.Map<IEnumerable<PaymentResponseDTO>>(coordinates));
    }
}
